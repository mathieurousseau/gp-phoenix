defmodule GpPhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GpPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GpPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
